...
public class ResolutionFeature extends CameraFeature<ResolutionPreset> {
  private static EncoderProfiles encoderProfiles;
  ...
  public static EncoderProfiles getBestAvailableCamcorderProfileForResolutionPreset(
    ...
    switch (preset) {
      ...
      //        int audioSampleRate,
      //        int audioChannels
//        CamcorderProfile ccc222w = new CamcorderProfile(
//                2,   //        int duration,
//                1,    //        int quality,
//                0,   //        int fileFormat,
//                0,  //        int videoCodec,
//                16,  //        int videoBitRate,
//                0,   //        int videoFrameRate,
//                900 ,  //        int videoWidth,
//                900,    //        int videoHeight,
//                0 ,   //        int audioCodec,
//                16,     //        int audioBitRate,
//                0 ,  //        int audioSampleRate,
//                0  //        int audioChannels
//                );

        //        EncoderProfiles enn222ww = new  EncoderProfiles(2, 3, new VideoProfile(900, 900, 1, 16, 1), new AudioProfile(1, 1, 1, 16, 1));
        //        return  enn222ww;
